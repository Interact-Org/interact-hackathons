...
const DialogFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div
    className={cn('w-full text-center flex flex-col-reverse text-xs font-medium text-gray-500 sm:flex-row sm:justify-end sm:space-x-2', className)}
    {...props}
  />
);
...
const DialogTitle = React.forwardRef<React.ElementRef<typeof DialogPrimitive.Title>, React.ComponentPropsWithoutRef<typeof DialogPrimitive.Title>>(
  ({ className, ...props }, ref) => (
    <DialogPrimitive.Title ref={ref} className={cn('text-3xl font-semibold leading-none tracking-tight', className)} {...props} />
  )
);
